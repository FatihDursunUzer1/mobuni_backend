...
namespace MobUni.Infrastructure.Migrations
{
    ...
    [Migration("20220418142052_userForeignKeyTest2")]
    partial class userForeignKeyTest2
    {
            ...
            modelBuilder.Entity("MobUni.ApplicationCore.Entities.UserAggregate.User", b =>
                {
                    ...
                    b.Property<int?>("FK_Users_Universities_UniversityId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FK_Users_Universities_UniversityId")
                        .IsUnique()
                        .HasFilter("[FK_Users_Universities_UniversityId] IS NOT NULL");
            ...
            modelBuilder.Entity("MobUni.ApplicationCore.Entities.UserAggregate.User", b =>
                {
                    ...
                    b.HasOne("MobUni.ApplicationCore.Entities.University", "University")
                        .WithOne()
                        .HasForeignKey("MobUni.ApplicationCore.Entities.UserAggregate.User", "FK_Users_Universities_UniversityId")
